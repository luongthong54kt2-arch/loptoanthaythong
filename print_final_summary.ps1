...
Write-Host "=========================================================================================================="
Write-Host "TỔNG HỢP HÓA ĐƠN ĐẶT SÁCH GIÁO KHOA THPT (TỪ FILE SGKTHPT.xlsx)"
Write-Host "=========================================================================================================="

$allOrders | Format-Table -Property Lop, STT, MaSach, TenSach, @{N='Giá Bìa (đ)';E={"{#:N0}" -f $_.GiaBia}}, SoLuong, @{N='Thành Tiền (đ)';E={"{#:N0}" -f $_.ThanhTien}}, GhiChu -AutoSize

$totalSL = ($allOrders | Measure-Object -Property SoLuong -Sum).Sum
$totalTT = ($allOrders | Measure-Object -Property ThanhTien -Sum).Sum

Write-Host "----------------------------------------------------------------------------------------------------------"
Write-Host "TỔNG CỘNG SỐ LƯỢNG SÁCH ĐẶT: $totalSL quyển"
Write-Host ("TỔNG CỘNG THÀNH TIỀN: {0:N0} VNĐ" -f $totalTT)
Write-Host "=========================================================================================================="
