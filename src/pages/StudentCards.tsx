    ...
    <div className="student-card" style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1 }}>
          <div style={{
            ...
            letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '1mm',
          }}>
            THẺ HỌC VIÊN
          </div>
          ...
          {classInfo?.subject && (
            <div style={{ color: 'rgba(255,255,255,0.65)', fontSize: '7px', marginTop: '1mm', fontWeight: 600 }}>
              {classInfo.subject}
            </div>
          )}
        </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          paddingLeft: '2mm', borderLeft: '0.3mm solid #f1f5f9',
        }}>
          <img src={qrSrc} alt="QR" style={{ width: '18mm', height: '18mm', display: 'block' }} />
          <div style={{ fontSize: '5px', color: '#9ca3af', fontWeight: 600, textAlign: 'center', lineHeight: 1.4 }}>
